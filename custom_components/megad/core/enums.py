...
class ModeOutMegaD(EnumMegaD):
    ...
    SW = 'relay'           # value = 'relay'
    PWM = 'pwm'           # value = 'pwm'
    DS2413 = 'one_wire_modul'  # value = 'one_wire_modul'
    SW_LINK = 'relay_link'     # value = 'relay_link'
    WS281X = 'rgb_tape'        # value = 'rgb_tape'
    ...
    def description(cls) -> dict:
        return {
            '0': 'relay',       # SW
            '1': 'pwm',        # PWM
            '2': 'one_wire_modul',  # DS2413
            '3': 'relay_link', # SW_LINK
            '4': 'rgb_tape',   # WS281X
        }
