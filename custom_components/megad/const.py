...
# Watchdog настройки
WATCHDOG_CHECK_INTERVAL = 60  # 1 минута
WATCHDOG_PING_TIMEOUT = 5     # 5 секунд
WATCHDOG_MAX_FAILURES = 2     # 2 ошибки перед восстановлением
WATCHDOG_RECOVERY_DELAY = 10  # 10 секунд между попытками
